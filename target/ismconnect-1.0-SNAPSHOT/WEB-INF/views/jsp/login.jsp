					...
					<div class="row">
						<div class="col-sm-8 col-sm-offset-2 text">
							...
							<div class="description">
								<p>This is a portal for students to learn from alumni and
									for alumni to share their knowledge in their respective
									domains.</p>
							</div>
						</div>
					</div>
						...
						<div class="col-sm-6 col-sm-offset-3 form-box">
							...
							<div class="form-bottom">
								<form role="form" action="/login/authenticate" method="post"
									...
									<br> Not registered yet? <a href="/signup">Sign up</a>
									now!
								</form>
							</div>
						</div>
